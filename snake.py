...
x_comida = round(random.randrange(0, 600 - d) / 20) * 20 #alinhar cobra e comida
...
# temos dois eixos por isso o jogo é considerado de 2D #
def mover_cobra(dx, dy, lista_cobra):
    ...
    # somar variação da movimentação das setas com a posição da cobra #
    # x = x + delta_x
    # y = y + delta_y
